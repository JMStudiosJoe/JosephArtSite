...
function About(props) {
    ...
    return (
        <div className='About'>
            ...
            <p className="quote-gap-one">"Art, Undeniably, is conductive to happiness." - unknown</p>
            ...
            <p className="quote-gap-two">"The world of reality has its limits; the world of imagination is boundless." - Jean-Jacques Rousseau</p>
