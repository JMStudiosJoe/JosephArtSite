    ...
    return (
        <div className='About'>
            ...
            <p className='about-para-3'>
                Joseph's goal is to stay a hobbiest painter with a devoted growing passion for art that will compliment and grow the engineer as well.  He will strive to bring people into a short story, make them wonder where the landscape is or where does this path lead to, and above all bring a person into the moment of wondrous illusion.
            </p>
        </div>
    )
}
